...
* [KivyMLApp](https://github.com/kaustubhgupta/KivyMLApp) **52⭐, 30** forks (The repository host the API for the ML model via FastAPI, Fl...) 
...
* [IEEEMAITSongs](https://github.com/kaustubhgupta/IEEEMAITSongs) **23⭐, 9** forks (Songs Lyrics Fetcher using Python on Frontend via Brython 🔥) 
