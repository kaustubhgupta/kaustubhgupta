...
* [KivyMLApp](https://github.com/kaustubhgupta/KivyMLApp) **46⭐, 28** forks (The repository host the API for the ML model via FastAPI, Fl...) 
* [WhatsApp-Groups-Analyser](https://github.com/kaustubhgupta/WhatsApp-Groups-Analyser) **36⭐, 14** forks (Web App that gives a detailed report about the WhatsApp Grou...) 
...
* [Trending-YTVideos-Dashboard](https://github.com/kaustubhgupta/Trending-YTVideos-Dashboard) **1⭐, 0** forks (Automated Trending YouTube Videos Dashboard [Updates Daily])<!-- PROJECTS END -->
