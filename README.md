...
## ⚡ Projects
<!-- PROJECTS START -->
* [PortfolioFy](https://github.com/kaustubhgupta/PortfolioFy) **91⭐, 22I** forks (🔥 Dynamically Self Updating Portfolio GitHub Actio...) 
* [WhatsApp-Groups-Analyser](https://github.com/kaustubhgupta/WhatsApp-Groups-Analyser) **21⭐, 8I** forks (This Web App gives a detailed report about the Wha...) 
* [KivyMLApp](https://github.com/kaustubhgupta/KivyMLApp) **14⭐, 13I** forks (This is an android app that has been backed using ...) 
* [IEEEMAITSongs](https://github.com/kaustubhgupta/IEEEMAITSongs) **7⭐, 6I** forks (This is a very basic approch to get the lyrics of ...) 
* [readme-projects-display](https://github.com/kaustubhgupta/readme-projects-display) **6⭐, 1I** forks (🔥 Display your projects information on your profil...) 
* [TelegramBot-IPU](https://github.com/kaustubhgupta/TelegramBot-IPU) **5⭐, 2I** forks (This bot receives the user inputs via webhook, mak...) 
* [Covid-Tweets-Analysis-Dashboard](https://github.com/kaustubhgupta/Covid-Tweets-Analysis-Dashboard) **5⭐, 3I** forks (This was the analysis from my side. I have tried t...) 
* [Technocolab-Final-Project](https://github.com/kaustubhgupta/Technocolab-Final-Project) **4⭐, 2I** forks (This repository contains the final project of the ...) 
* [IPUResultAndroidApp](https://github.com/kaustubhgupta/IPUResultAndroidApp) **4⭐, 1I** forks (The app fetches the data from the backend API and ...) 
* [FlaskWebsite](https://github.com/kaustubhgupta/FlaskWebsite) **3⭐, 0I** forks (This is a blogging website build with Python as ba...) 
* [IPU-Website](https://github.com/kaustubhgupta/IPU-Website) **2⭐, 1I** forks (IPU Results Portal, the best getaway to obtain res...) 
* [Data-Analysis-Hub](https://github.com/kaustubhgupta/Data-Analysis-Hub) **2⭐, 2I** forks (This is where all my Data Analysis notebooks are p...)<!-- PROJECTS END -->
